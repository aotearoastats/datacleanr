find_replace <- function(.DF, .index=NULL, .replace=NULL, .lookup=NULL, .name_vec, .all_variables=FALSE) {
  #' Renames the values on a variable according to a pattern-value map
  #'
